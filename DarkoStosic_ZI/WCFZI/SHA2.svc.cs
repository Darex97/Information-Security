...
namespace WCFZI
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "SHA2" in code, svc and config file together.
    // NOTE: In order to launch WCF Test Client for testing this service, please select SHA2.svc or SHA2.svc.cs at the Solution Explorer and start debugging.
    ...
    0x748f82ee,0x78a5636f,0x84c87814,0x8cc70208,0x90befffa,0xa4506ceb,0xbef9a3f7,0xc67178f2
        ...
        public string SHA2Calculate(string data)
        {
            ...
            SHA2Init(ref ctx);
            SHA2Update(ref ctx, Encoding.Default.GetBytes(data), (uint)data.Length);
            SHA2Final(ref ctx, hash);
        ...
        public void SHA2Final(ref SHA2_CTX ctx, byte[] hash)
        {
            uint i = ctx.datalen;
            ...
            else
            {
                ...
                SHA2Transform(ref ctx, ctx.data);
            }
        ...
        public void SHA2Init(ref SHA2_CTX ctx)
        {
            ctx.datalen = 0;
            ctx.bitlen[0] = 0;
            ctx.bitlen[1] = 0;
        ...
        public void SHA2Transform(ref SHA2_CTX ctx, byte[] data)
        {
        ...
        public void SHA2Update(ref SHA2_CTX ctx, byte[] data, uint len)
        {
