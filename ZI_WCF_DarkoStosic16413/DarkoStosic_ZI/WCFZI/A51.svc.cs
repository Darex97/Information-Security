...
namespace WCFZI
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "A51" in code, svc and config file together.
    // NOTE: In order to launch WCF Test Client for testing this service, please select A51.svc or A51.svc.cs at the Solution Explorer and start debugging.
    [ServiceBehavior(InstanceContextMode = InstanceContextMode.Single)]
    public class A51 : IA51
    {
